...
import classes from '/Users/rkumari/Desktop/01-starting-project/src/assets/component/UserInput/UserInput.module.css'
    ...
    <>
      <form onSubmit={SubmitHandler} className={classes.form}>
        ...
        <p className={classes.actions}>
          ...
          <button onClick={CalculateHandler} type="submit" className={classes.button}>
            Calculate
          </button>
        </p>
      </form>
